...
class AgentRunRow(Base):
    ...
    request_snapshot: Mapped[dict[str, object]] = mapped_column(JSON, nullable=False, default=dict)
    partial_answer: Mapped[str] = mapped_column(Text, nullable=False, default="")
