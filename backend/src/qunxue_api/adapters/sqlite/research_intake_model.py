...
class ResearchTaskRow(Base):
    ...
    project_stage: Mapped[str | None] = mapped_column(String(120), nullable=True)
    method_orientation: Mapped[str | None] = mapped_column(String(300), nullable=True)
    last_central_tool: Mapped[str | None] = mapped_column(String(32), nullable=True)
