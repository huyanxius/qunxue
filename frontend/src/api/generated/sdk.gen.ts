 ...
 */
export const listFrameworkVersions = <ThrowOnError extends boolean = false>(options: Options<ListFrameworkVersionsData, ThrowOnError>): RequestResult<ListFrameworkVersionsResponses, ListFrameworkVersionsErrors, ThrowOnError> => (options.client ?? client).get<ListFrameworkVersionsResponses, ListFrameworkVersionsErrors, ThrowOnError>({ url: '/api/frameworks/{framework_id}/versions', ...options });
